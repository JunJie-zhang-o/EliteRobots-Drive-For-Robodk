...
class RobotPost(object):
    ...
    def Pause(self, time_ms):
        ...
        self.addline2("TIMER T=%s" % str(time_ms/1000))
        pass
    ...
    def setDO(self, io_var, io_value):
        ...
        #DOUT OT#(2) ON
        self.addline2('DOUT %s %s' % (io_var, str(io_value)))
    ...
    def setAO(self, io_var, io_value):
        ...
        if type(io_value) != str:
            if io_value > 10:
                io_value = 10
        self.addline2('AOUT %s %s' % (io_var, str(io_value)))
    ...
    def waitDI(self, io_var, io_value, timeout_ms=-1):
        ...
        if type(io_value) != str:
            if io_value > 10:
                io_value = 10
        if timeout_ms > 0:
            self.addline2('WAIT %s=%s T=%s' % (io_var, str(io_value),str(round(timeout_ms/1000,3))))
        else:
            self.addline2('WAIT %s=%s' % (io_var, str(io_value)))
        # if type(io_var) != 
        pass
